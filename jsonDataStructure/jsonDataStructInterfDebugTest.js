...
our_interface.set_events_within_a_yearly_time_partition('work', 2019, 2020)
console.log(our_interface.accessor_object_filter_events())
// console.log('monthly partition')
// our_interface.set_events_within_a_monthly_time_partition('work', 2020, 1, 11)
// console.log(our_interface.accessor_object_filter_events())
// console.log('daily time partition')
// our_interface.set_events_within_a_daily_time_partition('work', 2020, 11, 22, 25)
// console.log(our_interface.accessor_object_filter_events())
...
// our_interface.solve_event_status_by_name('calc')
...
console.log('compute a list of filter events in period of day')
our_interface.solve_event_status_within_period_of_n_days('work', 2017, 2020, 8)
console.log(our_interface.accessor_object_period_status())
// console.log(our_interface.accessor_object_event_status())
